...
curl -s -X POST "https://api.telegram.org/bot8748074531:AAG2IPrztL_wjRcDWuaCLK8i43eRmi4WIMQ/setWebhook" \
  ...
  -d '{"url": "https://hostel-ferry-orchestra-offices.trycloudflare.com/webhooks/telegram", "allowed_updates": ["message", "edited_message", "callback_query"]}' | python3 -m json.tool
```
