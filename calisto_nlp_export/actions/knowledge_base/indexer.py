...
Also initialises BM25 index for hybrid retrieval.
"""
...
from actions.knowledge_base.hybrid_retriever import BM25
...
class KnowledgeSearcher:
    ...
    Holds both FAISS index and BM25 index for hybrid retrieval."""

    _instance: Optional["KnowledgeSearcher"] = None
    ...
    def __init__(self) -> None:
        ...
        corpus = [entry["text"] for entry in self.meta]
        self.bm25 = BM25(corpus)
        logger.info(
            "KnowledgeSearcher loaded: %d vectors, BM25 over %d docs",
            self.index.ntotal, len(corpus),
        )
    ...
    def search(self, query: str, top_k: int = 3) -> List[dict]:
        ...
        This is the original FAISS-only search, kept for backward compatibility."""
